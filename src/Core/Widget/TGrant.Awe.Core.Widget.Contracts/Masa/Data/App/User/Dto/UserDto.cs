...
namespace TGrant.Awe.Core.Widget.Contracts.Masa.Data.App.User.Dto;
...
public class UserDto : IComparable
{
    ...
    {
        get { return string.Join("", FullName.Split(' ').Select(n => n[0].ToString().ToUpper())); }
    }
    ...
    public UserDto(string status, string role, DateOnly birthDate, string mobile, string gender,
